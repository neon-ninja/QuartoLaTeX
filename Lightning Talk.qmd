...
fig = go.Figure(data=[go.Box(y=column_data,
...
# fig.add_trace(go.Scatter(x=[1], y=[mean_value], mode='lines+text', name='Mean', text=[f'Mean: {str(mean_value):.2f}']))
# fig.add_trace(go.Scatter(x=[1], y=[median_value], mode='lines+text', name='Median', text=[f'Median: {str(median_value):.2f}']))
...
mean_value_column_data = df['column_data'].mean()
